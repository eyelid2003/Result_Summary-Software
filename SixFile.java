...

{
	...
	SixFile(String filename,String pdfname,String sem)
	{
		...
		try
		{
			...
			while (sc.hasNext())
			{
				...
				if(matcher.find())
				{
					...
					totaladd=totaladd+1;
					PDDocument document = PDDocument.load(new File(pdfname));// here file1.pdf is the name of pdf file which we want to read....
					document.getClass();
